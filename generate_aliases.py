...
def main():
    ...
    globs = [
        ('sys', '--namespace=flux-system', None, ['m']),
        ('m', '--namespace=management', None, ['sys'])
    ]
    ...
    res = [
        ('hr', 'helmrelease', None, None),
        ('k', 'kustomization', None, None),
        ('h', 'source helm', None, None),
        ('g', 'source git', None, None),
        ('a', 'alert', None, None),
        ('i', 'image repository', None, None),
        ('u', 'image update', None, None),
        ('r', 'receiver', None, None),
    ]
    res_types = [r[0] for r in res]

    args = [
        ('an', '--all-namespaces', ['g'], None),
        ('all', '--all', ['s', 'e'], ['an']), 
        ]
